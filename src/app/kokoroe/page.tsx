          ...
          <div className="relative space-y-5 text-[clamp(16px,3.5vw,22px)] leading-[1.9] tracking-[0.02em]">
            ...
            <section>
              ...
              <ol className="jiro-list">
                ...
                <li>携帯電話の使用は、文明繁栄に貢献するとみなし特別に許可する。ハッシュタグ「#{site.title}」、メンション「@gachibunkasai」を付けたインスタでの発信活動は評価が高いものとする。YouTubeおよびBeRealは禁止とする。使用が発覚した場合は翌朝8時に中庭に集合し、生活指導の司令に従うものとする。</li>
