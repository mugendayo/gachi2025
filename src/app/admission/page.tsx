...
/* =========================================================
   スライド①：教育理念／求める生徒（画像左・テキスト右）
   ※ ボタンはテキスト右カラムの最下段に固定（grid）
========================================================= */
const SLIDES = [
  {
    id: "slide-a",
  ...
  return (
    <section className="py-10 md:py-14" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
      <div className="grid gap-6 md:grid-cols-2 items-start">
        ...
        {/* テキスト（右）— ボタンを最下段固定 */}
        <div className="grid grid-rows-[auto,1fr,auto] min-h-[340px]">
          ...
          <div className="mt-6 flex items-center gap-3">
            <button
              type="button"
              onClick={prev}
              className="rounded-xl border px-3 py-2 text-sm font-semibold hover:bg-blue-50"
              aria-label="前のスライド"
            >
              ← 前へ
            </button>
  ...
  return (
    <main className="bg-white text-slate-800">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        {/* スライド①：教育理念／求める生徒 */}
        <SlidesBlock />
{/* 3つのテーマ（円の“中”に英語＋直訳／円の下に説明カード） */}
<section className="py-12 md:py-16 border-y border-blue-100 bg-[#F8FBFF]">
  <h3 className="text-center text-[clamp(36px,8vw,56px)] font-bold text-[#103B73]">3つのテーマ</h3>
  ...
  <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-8 place-items-center">
    {[
      ...
      <div key={i} className="flex flex-col items-center text-center">
        {/* 円：relative にし、テキストは absolute で中央に固定 */}
        <div
          className="
        ...
        >
          {/* 中央テキスト：常に円の中 */}
          <div className="absolute inset-0 grid place-items-center text-white z-[1] px-3 text-center">
            <div className="leading-tight">
              <div className="text-[15px] sm:text-[17px] font-extrabold tracking-wide">
                {p.en}
              </div>
